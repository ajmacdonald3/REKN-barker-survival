...
writexl::write_xlsx(barker_res_df, "./analysis-output/covariate-models/pca/model_1_summary.xlsx")
...
plot(s_plot + plot_annotation(title = 'Figure 2'))
...
plot(fid_plot + plot_annotation(title = 'Figure S4'))
...
plot(psight_plot + plot_annotation(title = 'Figure S5'))
