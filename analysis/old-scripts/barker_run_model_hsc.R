...
covs_mat <- sapply(surv_covs[14:15], as.numeric)
covariates <- c("hsc", "hsc-lag")

# correlation matrix
covs_cor <- cor(surv_covs[14:15])
corrplot(covs_cor)
...
#### hsc ####
load("./analysis-output/covariate-models/hsc/model_hsc.RData")

print(barker.mod)

# traceplots
pdf(file = paste0("./analysis-output/covariate-models/hsc/traceplots/barker-hsc-traceplots.pdf"))
par(mfrow = c(3, 3))
...
for (i in colnames(sims.list)){
  ...
  png(filename = paste0("analysis-output/covariate-models/sst-anom/parameter-identifiability/",
                        i,"-","check.png"),
...
barker_res <- barker_res %>% 
  ...
  dplyr::select(parameter, mean, lcl, median, ucl)
...
# plot survival against hsc
hsc_eggs <- surv_covs %>% 
  dplyr::select(mean_hsc) %>% 
  mutate(year = 2010:2019)

s_hsc <- left_join(s_res, hsc_eggs, by = "year")

s_hsc_plot <- ggplot(data = s_hsc, aes(x=mean_hsc, y=mean)) +
...
png(filename = "analysis-output/covariate-models/hsc/figures/s-hsc-plot.png",
...
# standardized
hsc_eggs_std <- surv_covs_std %>% 
  dplyr::select(mean_hsc_std) %>% 
  mutate(year = 2010:2019)

s_hsc_std <- left_join(s_res, hsc_eggs_std, by = "year")

s_hsc_std_plot <- ggplot(data = s_hsc_std, aes(x=mean_hsc_std, y=mean)) +
  # geom_rect(data = filter(barker_res, parameter == "mean.s"),
  #           aes(xmin=-Inf, xmax=Inf, ymin=lcl, ymax=ucl), fill = "grey50", alpha=0.3) +
  # geom_hline(data = filter(barker_res, parameter == "mean.s"),
  #            aes(yintercept=mean)) +
  geom_errorbar(data = s_hsc_std, aes(x=mean_hsc_std, ymin=lcl, ymax=ucl),
                width=0, size=0.5, colour="black", linetype=1) +
  # geom_line(data = s_res, aes(x=as.factor(year), y=mean, group = var),
  #           linetype="dashed", size=0.5) +
  geom_point(size=3) +
  ...
  #ylim(0, 1) +
  ylab("Annual survival probability") +
  xlab("Standardized horseshoe crab egg abundance") +
  theme_cust() #+
#theme(axis.title.x = element_blank())
...
png(filename = "analysis-output/covariate-models/sst-anom/figures/s-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/sst-anom/figures/fid-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/sst-anom/figures/p-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/sst-anom/figures/osr-plot.png",
    width=6, height=4, units="in", res=600)
...
#### hsc-lag ####
load("./analysis-output/covariate-models/hsc-lag/model_hsc-lag.RData")

print(barker.mod)

# traceplots
pdf(file = paste0("./analysis-output/covariate-models/snow/traceplots/barker-snow-traceplots.pdf"))
par(mfrow = c(3, 3))
traceplot(barker.mod)
dev.off()
...
for (i in colnames(sims.list)){
  ...
  png(filename = paste0("analysis-output/covariate-models/snow/parameter-identifiability/",
                        i,"-","check.png"),
      width=4, height=3, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/snow/figures/s-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/snow/figures/fid-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/snow/figures/p-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/snow/figures/osr-plot.png",
    width=6, height=4, units="in", res=600)
...
load("./analysis-output/covariate-models/nao/model_nao.RData")

print(barker.mod)

# traceplots
pdf(file = paste0("./analysis-output/covariate-models/nao/traceplots/barker-nao-traceplots.pdf"))
par(mfrow = c(3, 3))
traceplot(barker.mod)
dev.off()
...
for (i in colnames(sims.list)){
  ...
  png(filename = paste0("analysis-output/covariate-models/nao/parameter-identifiability/",
                        i,"-","check.png"),
      width=4, height=3, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/nao/figures/s-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/nao/figures/fid-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/nao/figures/p-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/nao/figures/osr-plot.png",
    width=6, height=4, units="in", res=600)
...
#### arctic oscillation ####
load("./analysis-output/covariate-models/ao/model_ao.RData")

print(barker.mod)

# traceplots
pdf(file = paste0("./analysis-output/covariate-models/ao/traceplots/barker-ao-traceplots.pdf"))
par(mfrow = c(3, 3))
traceplot(barker.mod)
dev.off()
...
for (i in colnames(sims.list)){
  ...
  png(filename = paste0("analysis-output/covariate-models/ao/parameter-identifiability/",
                        i,"-","check.png"),
      width=4, height=3, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/ao/figures/s-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/ao/figures/fid-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/ao/figures/p-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/ao/figures/osr-plot.png",
    width=6, height=4, units="in", res=600)
...
# sst anom
load("./analysis-output/covariate-models/sst-anom/model_sst-anom.RData")

barker_res <- barker.mod$summary

beta_sstanom <- barker_res %>% 
  as.data.frame %>% 
  rownames_to_column() %>% 
  dplyr::rename(parameter = rowname) %>% 
  dplyr::rename(lcl = `2.5%`) %>% 
  ...
  dplyr::rename(ucl = `97.5%`) %>% 
  select(parameter, mean, lcl, median, ucl) %>% 
  filter(parameter %in% c("beta", "iv")) %>% 
  mutate(covariate = "Sea surface\ntemperature\nanomaly")

# snow
load("./analysis-output/covariate-models/snow/model_snow.RData")

barker_res <- barker.mod$summary

beta_snow <- barker_res %>% 
  as.data.frame %>% 
  rownames_to_column() %>% 
  dplyr::rename(parameter = rowname) %>% 
  dplyr::rename(lcl = `2.5%`) %>% 
...
beta_nao <- barker_res %>% 
  ...
  select(parameter, mean, lcl, median, ucl) %>% 
  filter(parameter %in% c("beta", "iv")) %>%
  mutate(covariate = "North Atlantic\nOscillation")
...
beta_ao <- barker_res %>% 
  ...
  select(parameter, mean, lcl, median, ucl) %>% 
  filter(parameter %in% c("beta", "iv")) %>%
  mutate(covariate = "Arctic\nOscillation")

# all
beta_est <- bind_rows(beta_sstanom, beta_snow, beta_nao, beta_ao)

beta_plot <- ggplot() +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_errorbar(data = beta_est %>% filter(parameter == "beta"),
                aes(x=covariate, ymin=lcl, ymax=ucl),
                width=0, size=0.5, colour="black", linetype=1) +
  geom_point(data = beta_est %>% filter(parameter == "beta"),
             aes(x=covariate, y=mean), size=3) +
  geom_point(data = beta_est %>% filter(parameter == "iv"),
             aes(x=covariate, y=mean), size=2, shape = 23, fill = "white") +
  ylab("Standardized effect size (\u03B2 ± 95% CI)\nand indicator variable estimate") +
  coord_flip() +
  theme_cust() +
  theme(axis.title.y = element_blank())

png(filename = "analysis-output/covariate-models/beta-plot.png",
    width=6, height=4, units="in", res=600)
...
# save results
saveRDS(barker.mod$summary, file = paste0("./analysis-output/covariate-models/none/barker-summary.rds"))

saveRDS(barker.mod$sims.list, file = paste0("./analysis-output/covariate-models/none/barker-simslist.rds"))

save(barker.mod, file = "./analysis-output/covariate-models/none/model_none.RData")

################################################################################
# plot results
################################################################################

load("./analysis-output/covariate-models/none/model_none.RData")

# traceplots
pdf(file = paste0("./analysis-output/covariate-models/none/traceplots/barker-none-traceplots.pdf"))
par(mfrow = c(3, 3))
traceplot(barker.mod)
dev.off()
...
for (i in colnames(sims.list)){
  ...
  png(filename = paste0("analysis-output/covariate-models/none/parameter-identifiability/",
                        i,"-","check.png"),
      width=4, height=3, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/none/figures/s-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/none/figures/fid-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/none/figures/p-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/none/figures/osr-plot.png",
    width=6, height=4, units="in", res=600)
...
png(filename = "analysis-output/covariate-models/none/figures/psight-plot.png",
    width=6, height=4, units="in", res=600)
