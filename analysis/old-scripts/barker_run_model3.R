...
covs_mat <- sapply(surv_covs[9:12], as.numeric)
covariates <- c("sst-anom", "snow", "nao", "ao")

# correlation matrix
covs_cor <- cor(surv_covs[9:12])
corrplot(covs_cor)
...
# traceplots
pdf(file = paste0("./analysis-output/covariate-models/sst-anom/traceplots/barker-sst-anom-traceplots.pdf"))
par(mfrow = c(3, 3))
